...
def predict(req: PredictRequest) -> PredictResponse:
    ...
    with tracer.start_as_current_span("predict") as span:
        ...
        span.set_attribute("gen_ai.request.prompt_length", len(req.prompt))
        ...
        try:
            ...
            with tracer.start_as_current_span("embed-text") as s:
                s.set_attribute("gen_ai.operation.name", "embeddings")
            ...
            span.set_attribute("gen_ai.response.quality_score", quality)
